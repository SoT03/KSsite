...
export const ITEMS: WatchItem[] = [
  ...
  { id: "mcu-black-widow", title: "Black Widow", universe: "mcu", phase: "Phase 3", requires: ["mcu-cap-america-civil-war"], mediaType: "movie", tag: "together" },
  {
  ...
  { id: "mcu-spiderman-homecoming", title: "Spider-Man: Homecoming", universe: "mcu", phase: "Phase 3", requires: ["mcu-cap-america-civil-war"], mediaType: "movie", tag: "together" },
  { id: "mcu-doctor-strange-1", title: "Doctor Strange", universe: "mcu", phase: "Phase 3", requires: ["mcu-black-widow", "mcu-black-panther-1", "mcu-spiderman-homecoming"], mediaType: "movie", tag: "together" },
  { id: "mcu-thor-ragnarok", title: "Thor: Ragnarok", universe: "mcu", phase: "Phase 3", requires: ["mcu-doctor-strange-1"], mediaType: "movie", tag: "together" },
  { id: "mcu-ant-man-wasp", title: "Ant-Man and the Wasp", universe: "mcu", phase: "Phase 3", requires: ["mcu-doctor-strange-1"], mediaType: "movie", tag: "together" },
  {
    id: "mcu-infinity-war",
  ...
  { id: "mcu-loki-s1", title: "Loki Season 1", universe: "mcu", phase: "Phase 3", requires: ["mcu-endgame"], episodes: 6, mediaType: "tv" },

  /* ---------------------------- MCU — Phase 4 ---------------------------- */
  { id: "mcu-wandavision", title: "WandaVision", universe: "mcu", phase: "Phase 4", requires: ["mcu-endgame"], episodes: 9, mediaType: "tv" },
  { id: "mcu-shang-chi", title: "Shang-Chi and the Legend of the Ten Rings", universe: "mcu", phase: "Phase 4", requires: ["mcu-endgame"], mediaType: "movie", tag: "together" },
  { id: "mcu-falcon-winter-soldier", title: "The Falcon and the Winter Soldier", universe: "mcu", phase: "Phase 4", requires: ["mcu-endgame"], episodes: 6, mediaType: "tv" },
  ...
  { id: "mcu-spiderman-no-way-home", title: "Spider-Man: No Way Home", universe: "mcu", phase: "Phase 4", requires: ["mcu-spiderman-far-from-home"], mediaType: "movie", tag: "together" },
  ...
  { id: "mcu-gotg-3", title: "Guardians of the Galaxy Vol. 3", universe: "mcu", phase: "Phase 5", requires: ["mcu-thor-love-thunder"], mediaType: "movie", tag: "together" },
  {
  ...
  { id: "mcu-loki-s2", title: "Loki Season 2", universe: "mcu", phase: "Phase 5", requires: ["mcu-loki-s1"], episodes: 6, mediaType: "tv", tag: "together" },
  {
    id: "mcu-echo-s1",
    title: "Echo Season 1",
    universe: "mcu",
  ...
  { id: "mcu-deadpool-wolverine", title: "Deadpool & Wolverine", universe: "mcu", phase: "Phase 5", requires: ["fox-xmen-deadpool-2"], mediaType: "movie", tag: "together" },
  {
  ...
  { id: "mcu-spiderman-brand-new-day", title: "Spider-Man: Brand New Day", universe: "mcu", phase: "Phase 6", requires: ["mcu-spiderman-no-way-home"], mediaType: "movie", tag: "together" },
  {
  ...
  { id: "sony-amazing-spiderman-2", title: "The Amazing Spider-Man 2", universe: "sony-spiderman", phase: "Movies", requires: ["sony-amazing-spiderman-1"], mediaType: "movie", tag: "together" },

  /* ---------------------------- Fox X-Men ---------------------------- */
  { id: "fox-xmen-first-class", title: "X-Men: First Class", universe: "fox-xmen", phase: "Movies", mediaType: "movie", tag: "together" },
  { id: "fox-xmen-origins-wolverine", title: "X-Men Origins: Wolverine", universe: "fox-xmen", phase: "Movies", mediaType: "movie", tag: "together" },
  { id: "fox-xmen", title: "X-Men", universe: "fox-xmen", phase: "Movies", requires: ["fox-xmen-first-class", "fox-xmen-origins-wolverine"], mediaType: "movie", tag: "together" },
  { id: "fox-xmen-2", title: "X2: X-Men United", universe: "fox-xmen", phase: "Movies", requires: ["fox-xmen"], mediaType: "movie", tag: "together" },
  ...
  { id: "fox-xmen-deadpool-2", title: "Deadpool 2", universe: "fox-xmen", phase: "Movies", requires: ["fox-xmen-deadpool"], mediaType: "movie", tag: "together" },
  ...
  { id: "fox-xmen-logan", title: "Logan", universe: "fox-xmen", phase: "Movies", requires: ["fox-xmen-the-wolverine", "fox-xmen-days-of-future-past"], mediaType: "movie", tag: "together" },
  ...
  { id: "sony-verse-venom-last-dance", title: "Venom: The Last Dance", universe: "sony-verse", phase: "Movies", requires: ["sony-verse-venom-let-there-be-carnage"], mediaType: "movie", tag: "together" },
  ...
  {
    id: "disney-extras-jessica-jones-s1",
  ...
  {
    id: "disney-extras-jessica-jones-s3",
    title: "Jessica Jones Season 3",
    universe: "disney-extras",
    phase: "Netflix Marvel",
    requires: ["disney-extras-jessica-jones-s2"],
    episodes: 13,
    mediaType: "tv",
    tag: "skip",
  },
