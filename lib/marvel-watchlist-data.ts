...
export const ITEMS: WatchItem[] = [
  ...
  { id: "disney-extras-jessica-jones-s3", title: "Jessica Jones Season 3", universe: "disney-extras", phase: "Netflix Marvel", requires: ["disney-extras-jessica-jones-s2"], episodes: 13, mediaType: "tv", tag: "skip" },
];
